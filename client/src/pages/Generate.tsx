                          ...
                          <div className="p-6 rounded-2xl bg-white/8 border-white/12 shadow-xl space-y-6">
                            ...
                            <div className="space-y-5">
                              ...
                              <div className="space-y-2">
                                ...
                                <input type="text" value={title} onChange={(e) => setTitle(e.target.value)} maxLength={100} placeholder="e.g., 10 Tips for Better Sleep" className="w-full px-4 py-3 rounded-lg border border-white/12 bg-black/20 placeholder:text-zinc-400 text-zinc-100 focus:ring-2 focus:ring-pink-500 focus:outline-none"/>
                              ...
                              <div className="space-y-2">
                                ...
                                <textarea value={additionalDetails} onChange={(e)=>setAdditionalDetails(e.target.value)} rows={3} placeholder="Add any specific elements, mood, or style preferences..." className="w-full px-4 py-3 rounded-lg border border-white/10 bg-white/6 placeholder:text-zinc-400 text-zinc-100 focus:ring-2 focus:ring-pink-500 focus:outline-none resize-none"/>
