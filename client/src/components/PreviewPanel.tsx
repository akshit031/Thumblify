        ...
        {isLoading && (
          <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-black/25">
            ...
            <div className="text-center">
              <p className="text-sm font-medium text-zinc-200">Generating your thumbnail...</p>
              <p className="mt-1 text-xs text-zinc-400">This may take up to 20 seconds</p>
            </div>
          </div>
        )}
        ...
        {!isLoading && thumbnail?.image_url && (
          <div className="group relative h-full w-full">
            ...
            <div className="absolute inset-0 flex items-end justify-center bg-black/10 opacity-0 group-hover:opacity-100 transition-opacity">
              <button onClick={onDownload} type="button" className="mb-4 flex items-center gap-2 rounded-md bg-white/30 px-5 py-2.5 text-xs font-medium transition ring-2 ring-white/40 backdrop-blur hover:scale-105 active:scale-95">
        ...
        {!isLoading && !thumbnail?.image_url && (
          <div className="absolute inset-0 m-2 flex flex-col items-center justify-center gap-4 rounded-lg border-2 border-dashed border-white/20 bg-black/25">
            ...
            <div className="px-4 text-center">
              <p className="textfont text-zinc-200">Generate your first thumbnail</p>
